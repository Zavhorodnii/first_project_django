    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fees_in_usa', models.PositiveIntegerField(default=0, help_text='указать сумму в долларах', verbose_name='Сбор в США')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, verbose_name='Имя')),
                ('test', models.TextField(max_length=5000, verbose_name='Сообщение')),
